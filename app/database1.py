...
# Credenciales en .env
MYSQL_USER = os.getenv("M_USER")
MYSQL_PASSWORD = os.getenv("M_PASSWORD")
MYSQL_HOST = os.getenv("M_HOST")
MYSQL_PORT = os.getenv("M_PORT")
MYSQL_DATABASE = os.getenv("M_DATABASE")
...
# Ruta al archivo .sql
SQL_FILE_PATH = "app/sql/takoyaki.sql"
